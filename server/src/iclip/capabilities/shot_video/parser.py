...
## 5、剪辑形式
两句连贯的文字，不分点：剪辑节奏（以哪种切换方式为主、用了别的切换的是哪几镜、有慢动作或快放的是哪一镜，其余正常速度）、拍摄手法（固定机位还是手持跟拍为主、常用的机位高度与角度）。每句都要能在第 4 节找到依据，不写音乐节拍、光线色调和「高级感」「氛围感」这类词。

**【撰写示例】**
*(注：此示例仅展示要写的内容与句式，不代表任何输入视频内容。)*

以硬切为主，第 3 镜前匹配剪辑，第 2 镜鞋底压水为慢动作，其余正常速度。手持轻微跟拍与低机位贴地固定为主，以平视为多。
